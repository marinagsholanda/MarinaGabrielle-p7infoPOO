...
let cliente = new Cliente(1, "Marine Gabrielle Silva Holanda", 100, "666.666.666.69",TipoCliente.PESSOA_FISICA);
console.log("=========================");
console.log(cliente);
console.log("=========================");
...
let p1 = new Produto(1, 150, "Arroz     Gbismo", 6.50);
let p2 = new Produto(2, 200, "Feijão  Tio João", 8.00);
let p3 = new Produto(3, 300, "Farinha Juliette", 5.50);
